class Pergunta extends Phaser.Scene {
    ...
    createPergunta() {
        ...
        let textPadding = [];
        textPadding.push({ left: (1400 - perguntaText.getBounds().width) / 2, right: (1400 - perguntaText.getBounds().width) / 2, top: (200 - perguntaText.getBounds().height) / 2, bottom: (200 - perguntaText.getBounds().height) / 2 });
